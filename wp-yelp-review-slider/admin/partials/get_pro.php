...
<a href="https://wpreviewslider.com/" class="btn_green dashicons-before dashicons-external"><?php _e('Get Pro Version Here!', 'wp-yelp-reviews'); ?></a>

<ul style="
    list-style-type: circle;
    margin-left: 30px;
">
	<li>Grab all your reviews using our new Review Funnels feature.</li>
	<li>Customer support via email and a forum.</li>
	<li>Front end submission form!</li>
	<li>Download your reviews from Yelp, Facebook, TripAdvisor, Google, and 50+ other sites as well!</li>
...
<div class="w3_wprs-row">
	...
	<div>	
	<a href="https://wpreviewslider.com/" class="btn_green dashicons-before dashicons-external" target="_blank"><?php _e('Get Pro Version Here!', 'wp-yelp-reviews'); ?></a>
	</div>
</div>
