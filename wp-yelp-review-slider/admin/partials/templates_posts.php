...
<tr class="wpyelp_row">
			...
			<tr class="wpfbr_row">
				<th scope="row">
					<?php _e('Filter By Rating:', 'wp-fb-reviews'); ?>
				</th>
				<td>
			...
			<tr>
				<td class="notice updated " colspan="2" style="border-left: 4px solid #d6d6d6;">
					<p><strong><?php _e('Upgrade to the <a href="https://wpreviewslider.com/">Pro Version</a> of this plugin to access more super cool settings!', 'wp-fb-reviews'); ?></strong></p>
				</td>
			</tr>
